...
if ( ! function_exists( 'activate_svg_map_by_saedi' ) ) {
	/**
...
if ( ! function_exists( 'deactivate_svg_map_by_saedi' ) ) {
	/**
...
if ( ! function_exists( 'svg_map_setup_menu' ) ) {
...
if ( ! function_exists( 'svg_map_init' ) ) {
